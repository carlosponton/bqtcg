-- Fase 5: create_listing() exige ciudad (sin fallback 'Barranquilla') y conserva
-- el soporte de decks de 20260908000002. Un archivo por función; sin comentarios
-- dentro del cuerpo plpgsql a propósito.
